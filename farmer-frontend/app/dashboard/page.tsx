  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#1F2922] font-sans antialiased selection:bg-[#1C3A27] selection:text-white flex flex-col md:flex-row">
      ...
      <header className="md:hidden sticky top-0 z-40 bg-[#FDFBF7]/90 backdrop-blur-md px-4 py-3 flex items-center justify-between border-b border-[#EBE7DF]">
        ...
        <h1 className="text-xl font-serif font-bold text-[#1C3A27]">CropGuard</h1>
          ...
          <aside className="relative w-72 bg-[#1E1915] text-[#D1D5DB] flex flex-col justify-between p-4 z-10 overflow-y-auto">
            <div>
              <div className="flex items-center justify-between px-2 py-3 mb-4">
                <div>
                  <h1 className="font-serif font-bold text-lg text-white">CropGuard</h1>
                  <p className="text-[11px] text-[#A1A1A1] font-mono uppercase">Agri-Intelligence</p>
                </div>
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-sm font-medium ${
                        isActive ? 'bg-[#2D6A4F] text-white' : 'text-[#A3A3A3] hover:text-white'
                      }`}
                    >
          ...
          <nav className="space-y-1">
            {navigationItems.map((item) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <Icon className={`w-4 h-4 ${isActive ? 'text-white' : 'text-[#8A8A8A]'}`} />
                    <span>{item.name}</span>
                  </div>
                  {item.badge && (
                    <span className="bg-[#D97706] text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full">
      ...
      <div className="md:pl-64 flex-1 min-h-screen pb-20 md:pb-8 flex flex-col min-w-0">
        ...
        <main className="p-4 md:p-8 space-y-6 max-w-[1600px] mx-auto w-full">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl font-serif font-bold text-[#1F2922] tracking-tight">Overview</h1>
              <p className="text-xs md:text-sm text-gray-600 mt-0.5">Real-time agricultural telemetry & AI insights across Maharashtra.</p>
            </div>
          ...
          {showAlertBanner && (
            <div className="bg-[#FFEBE5] border border-[#FFD0C4] p-4 rounded-2xl flex items-start justify-between gap-3 shadow-sm">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 rounded-full bg-[#D99B00] flex items-center justify-center text-white shrink-0 mt-0.5">
                  <CloudLightning className="w-5 h-5" />
                </div>
                <div>
                  <h3 className="text-sm font-bold text-gray-900">Heavy rain & high risk weather alert</h3>
                  <p className="text-xs text-gray-600 mt-1 leading-relaxed">
                    Waterlogging warning for lower elevation plots in Nashik. Adjust automated irrigation cycles accordingly.
                  </p>
                </div>
              </div>
              <button 
                onClick={() => setShowAlertBanner(false)}
                className="text-xs font-semibold text-gray-500 hover:text-gray-800 hidden sm:block"
              >
                Dismiss
              </button>
            </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
            <div className="bg-white p-4 md:p-5 rounded-2xl border border-[#ECE8DC] shadow-sm">
              <span className="text-[10px] md:text-xs font-medium text-gray-500 uppercase tracking-wider">Total Monitored</span>
              <div className="mt-2 md:mt-3">
                <span className="text-xl md:text-2xl font-bold text-gray-900">4,285</span>
              </div>
              <p className="text-[10px] md:text-xs text-emerald-600 mt-1 font-medium">📈 +12% this month</p>
            </div>

            <div className="bg-white p-4 md:p-5 rounded-2xl border border-[#ECE8DC] shadow-sm">
              <span className="text-[10px] md:text-xs font-medium text-gray-500 uppercase tracking-wider">AI Scans Today</span>
              <div className="mt-2 md:mt-3">
                <span className="text-xl md:text-2xl font-bold text-gray-900">1,492</span>
              </div>
              <p className="text-[10px] md:text-xs text-emerald-600 mt-1 font-medium">✓ 98% accuracy</p>
            </div>

            <div className="bg-white p-4 md:p-5 rounded-2xl border border-[#ECE8DC] shadow-sm">
              <span className="text-[10px] md:text-xs font-medium text-gray-500 uppercase tracking-wider">Active Alerts</span>
              <div className="mt-2 md:mt-3">
                <span className="text-xl md:text-2xl font-bold text-amber-600">24</span>
              </div>
              <p className="text-[10px] md:text-xs text-amber-700 mt-1 font-medium">Action required</p>
            </div>

            <div className="bg-white p-4 md:p-5 rounded-2xl border border-[#ECE8DC] shadow-sm">
              <span className="text-[10px] md:text-xs font-medium text-gray-500 uppercase tracking-wider">High-Risk Locs</span>
              <div className="mt-2 md:mt-3">
                <span className="text-xl md:text-2xl font-bold text-red-600">7</span>
              </div>
              <p className="text-[10px] md:text-xs text-red-700 mt-1 font-medium">Nashik & Pune</p>
            </div>

            <div className="bg-white p-4 md:p-5 rounded-2xl border border-[#ECE8DC] shadow-sm col-span-2 sm:col-span-1">
              <span className="text-[10px] md:text-xs font-medium text-gray-500 uppercase tracking-wider">Pending Review</span>
              <div className="mt-2 md:mt-3">
                <span className="text-xl md:text-2xl font-bold text-gray-900">188</span>
              </div>
              <p className="text-[10px] md:text-xs text-gray-500 mt-1 font-medium">94% confirmed</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white p-5 rounded-2xl border border-[#ECE8DC] shadow-sm flex flex-col justify-between">
                  <div>
                    ...
                    <div className="mt-2">
                      <span className="text-4xl font-serif font-bold text-gray-900">34°C</span>
                      <span className="text-xs text-gray-500 ml-2">Partly Cloudy, Nashik</span>
                    </div>
                  </div>
                  <div className="grid grid-cols-3 gap-2 mt-4 text-center">
                    ...
                    <div className="bg-[#F8F6F0] p-2 rounded-xl">
                      ...
                      <span className="text-xs font-bold block mt-1">14km/h</span>
                ...
                <div className="bg-[#263328] p-4 rounded-2xl border border-[#2E3D30] shadow-sm text-white flex flex-col justify-between relative overflow-hidden min-h-40">
                  ...
                  <div className="flex justify-between items-center z-10">
                    <span className="text-xs font-bold bg-white/10 px-2.5 py-1 rounded-md backdrop-blur-md">Hotspots: Maharashtra</span>
                    <span className="text-[10px] font-mono text-emerald-400">Live Satellite</span>
                  </div>
                  <div className="my-6 relative h-20">
                    ...
                    <span className="absolute top-1 left-16 text-[10px] font-bold text-amber-300">Nashik Plot A</span>
                    ...
                    <span className="absolute bottom-2 right-16 text-[10px] font-bold text-red-400">Pune North</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-4 md:p-6 rounded-2xl border border-[#ECE8DC] shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="font-serif font-bold text-base md:text-lg text-gray-900">Regional Outbreak Risk Forecast</h3>
                    <p className="text-xs text-gray-500">Downy Mildew & Rust incidence projection over 30 days</p>
                  </div>
                  <span className="text-xs font-bold text-[#2D6A4F] bg-[#E8F5E9] px-2.5 py-1 rounded-md">Weekly Trend</span>
                </div>
                <div className="h-52 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={outbreakData}>
                      ...
                      <Tooltip />
                      <Area type="monotone" dataKey="incidence" stroke="#2D6A4F" fill="#2D6A4F" fillOpacity={0.15} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-[#ECE8DC] shadow-sm text-center">
                <h3 className="font-serif font-bold text-base text-gray-900 text-left mb-4">Overall Risk Level</h3>
                ...
                <h4 className="text-xs font-bold uppercase tracking-wider text-amber-600 mt-4">Elevated Risk</h4>
                <p className="text-[11px] text-gray-500 mt-1">Driven by high humidity in Nashik sector.</p>
              </div>

              {/* PRIORITY ALERTS */}
              <div className="bg-white p-6 rounded-2xl border border-[#ECE8DC] shadow-sm space-y-3">
                <h3 className="font-serif font-bold text-base text-gray-900">Priority Alerts</h3>
                <div className="bg-red-50 p-3 rounded-xl border border-red-100 text-xs">
                  <div className="flex items-center gap-2 font-bold text-red-700">
                    <AlertCircle className="w-4 h-4" />
                    Pest Outbreak Detected
                  </div>
                  <p className="text-[11px] text-red-600 mt-1">Fall Armyworm clustering in Pune North fields.</p>
                </div>
                <div className="bg-amber-50 p-3 rounded-xl border border-amber-100 text-xs">
                  ...
                  <p className="text-[11px] text-amber-600 mt-1">Forecast suggests prolonged temperatures above 38°C.</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div className="lg:col-span-8 bg-white p-4 md:p-6 rounded-2xl border border-[#ECE8DC] shadow-sm space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-serif font-bold text-base md:text-lg text-gray-900">AI Diagnoses & Field Telemetry</h3>
                  <p className="text-xs text-gray-500">Live inspection records across registered crop sectors.</p>
                </div>
                <button className="text-xs font-semibold text-[#2D6A4F] hover:underline">View All Logged Cases</button>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse min-w-150">
                  ...
                  <tbody className="divide-y divide-gray-100 text-xs font-medium">
                    <tr>
                      <td className="py-3.5 px-3 font-bold text-gray-900">Sector 4A</td>
                      <td className="py-3.5 px-3 text-gray-600">Tomato / Grapes</td>
                      <td className="py-3.5 px-3">94%</td>
                      <td className="py-3.5 px-3 text-[#D32F2F] font-bold">Downy Mildew</td>
                      <td className="py-3.5 px-3">
                        <span className="bg-[#FFEBEE] text-[#D32F2F] px-2.5 py-1 rounded-md font-bold text-[10px]">High Risk</span>
                      </td>
                      <td className="py-3.5 px-3 text-right">
                        <button onClick={() => showToast("Viewing Sector 4A Details")} className="p-1.5 hover:bg-gray-100 rounded-lg text-gray-600">
                          <Eye className="w-4 h-4" />
                        </button>
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3.5 px-3 font-bold text-gray-900">North Block 2</td>
                      <td className="py-3.5 px-3 text-gray-600">Cotton</td>
                      <td className="py-3.5 px-3">88%</td>
                      <td className="py-3.5 px-3 text-[#B45309] font-bold">Aphid Infestation</td>
                      <td className="py-3.5 px-3">
                        <span className="bg-[#FFF3E0] text-[#D97706] px-2.5 py-1 rounded-md font-bold text-[10px]">Monitoring</span>
                      </td>
                      <td className="py-3.5 px-3 text-right">
                        <button onClick={() => showToast("Viewing North Block 2 Details")} className="p-1.5 hover:bg-gray-100 rounded-lg text-gray-600">
                          <Eye className="w-4 h-4" />
                        </button>
                      </td>
                    </tr>
                    <tr>
                      <td className="py-3.5 px-3 font-bold text-gray-900">South Field 1</td>
                      <td className="py-3.5 px-3 text-gray-600">Maize</td>
                      <td className="py-3.5 px-3">99%</td>
                      <td className="py-3.5 px-3 text-emerald-700 font-bold">Healthy Leaf</td>
                      <td className="py-3.5 px-3">
                        <span className="bg-[#E8F5E9] text-[#2D6A4F] px-2.5 py-1 rounded-md font-bold text-[10px]">Optimal</span>
                      </td>
                      <td className="py-3.5 px-3 text-right">
                        <button onClick={() => showToast("Viewing South Field 1 Details")} className="p-1.5 hover:bg-gray-100 rounded-lg text-gray-600">
                          <Eye className="w-4 h-4" />
                        </button>
                      </td>
                    </tr>
            ...
            <div className="lg:col-span-4 bg-white p-6 rounded-2xl border border-[#ECE8DC] shadow-sm flex flex-col justify-between">
              <div>
                <h3 className="font-serif font-bold text-base text-gray-900 mb-4">Quick Actions</h3>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-[#EBE7DF] px-6 py-2 flex items-center justify-between shadow-lg">
        {[
          ...
          return (
            ...
            >
              <div className={`p-1.5 rounded-xl ${isActive ? 'bg-[#1C3A27] text-white' : ''}`}>
